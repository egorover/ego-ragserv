...
> 🛠 **Credits**: Данный проект основан на базе репозитория/шаблона преподавателя ZeroCoder Даниила Соболева — (https://github.com/MrGAN12009/MrGAN12009). 
> Проект был структурно переработан, расширен поддержкой новых провайдеров через сервис ProxyAPI и адаптирован для личного портфолио.
